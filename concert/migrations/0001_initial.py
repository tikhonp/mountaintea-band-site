    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template', models.TextField(default='<p>Добавьте страницу концерта</p>',
                                              verbose_name='template to show concert page')),
            ],
        ),
        migrations.CreateModel(
            name='Price',
            fields=[
                ...
                ('currency', models.CharField(
                    choices=[('RUB', 'рубль'), ('EUR', 'евро'), ('USD', 'доллар'), ('GBP', 'британский фунт')],
                    default='RUB', max_length=3, verbose_name='price currency')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='concert.price',
                                            verbose_name='the related price')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', phonenumber_field.modelfields.PhoneNumberField(blank=True, default=None,
                                                                         help_text='Контактный телефон', max_length=128,
